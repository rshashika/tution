         ...
         <div class="card ">
          ...
          <div class="row">
              ...
              <div class="form-actions">
                <button type="button" id="tempadd" class="btn btn-success btn-sm"><i class="ik save ik-save"></i> Save </button>
              ...
              <tbody>
               ...
               <!--  </td> -->
                 ...
                 <td class="center"><!-- <a  href="{{ url('/admin/delete-feestemp/'.$bill->id) }}" class="btn btn-danger btn-sm" onclick="return confirm('Are you Sure Delete  ?')"> -->
                  <a class="deleteRecord btn btn-danger btn-sm" rel="{{ $bill->id }}" rel1="delete-registrationfees" href="javascript:">
