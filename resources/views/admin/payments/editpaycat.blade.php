         ...
         <div class="card ">
          <!-- <div class="card-header">
            <h3 class="card-title">Student Information</h3>
                ...
                <form action="{{ url('admin/edit-paymentcat/'.$leaves->id) }}" method="POST" id="createDeduction">
                    @csrf
                     <div class="card-body">
                    <div class="row">
                      <div class="col-md-6 ">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" id="name" value="{{ $leaves->title }}" required>
                    </div>
                    <div class="form-group">
                        <label for="amount">Amount</label><small class="text-danger">*</small>
                        <input type="text" name="amount" class="form-control" id="amount" value="{{ $leaves->amount }}"  autocomplete="off">
                    </div>
                </div>
                <div class="col-md-6 ">
                        ...
                        <div class="form-group">
                          ...
                          <textarea class="form-control" id="description" name="description">{{ $leaves->description }}</textarea>
