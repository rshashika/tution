  ...
  @if(Session::has('flash_message_error'))
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Student Payment Category</h1>
          </div>
          <!-- <div class="col-sm-6">
         ...
         <div class="card ">
          <!-- <div class="card-header">
            <h3 class="card-title">Student Information</h3>
                ...
                <form action="{{ url('admin/add-paymentcat') }}" method="POST" id="createDeduction">
                    @csrf
                     <div class="card-body">
                    <div class="row">
                      <div class="col-md-6 ">
                    ...
                    <div class="form-group">
                        <label for="name">Title</label><small class="text-danger">*</small>
                                      ...
                                      <td>{{ $class->description }}</td>
                                       ...
                                       <td class="text-center">
                                          <div class="table-actions" style="text-align:center;"> 
                                             <a href="{{ url('/admin/edit-paymentcat/'.$class->id) }}" class="btn btn-info btn-sm">
                                              <i class="fas fa-pencil-alt">
                                              </i> Edit
                                             <!-- <img src="https://img.icons8.com/color/20/000000/edit--v1.png"/> -->
                                             </a>
                                              <!-- <a rel="{{ $class->id }}" rel1="delete-eloccate" href="javascript:" class="del cursure-pointer mr-2 deleteRecord" > <i class='ik ik-trash-2 text-danger'></i> </a> -->
                                               <a  class="deleteRecord btn btn-danger btn-sm" rel="{{ $class->id }}" rel1="delete-paymentcat" href="javascript:" > <i class="fas fa-trash">
                                              </i> Delete</a>
