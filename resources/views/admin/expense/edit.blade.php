         ...
         <div class="card ">
          <!-- <div class="card-header">
            <h3 class="card-title">Student Information</h3>
                ...
                <form action="{{ url('admin/edit-expensecat/'.$expensecat->id) }}" method="POST" id="createDeduction">
                    @csrf
                     <div class="card-body">
                    <div class="row">
                      <div class="col-md-6 ">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="ex_title" class="form-control" id="name" value="{{ $expensecat->ex_title}}" required> 
                    </div>
                   <!--  <div class="form-group">
