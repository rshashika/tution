         ...
         <div class="card ">
          <!-- <div class="card-header">
            <h3 class="card-title">Student Information</h3>
                ...
                <form action="{{ url('admin/edit-feescat/'.$expensecat->id) }}" method="POST" id="createDeduction">
                    @csrf
                     <div class="card-body">
                    <div class="row">
                      <div class="col-md-6 ">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="fe_title" class="form-control" id="name" value="{{ $expensecat->fe_title}}" required> 
                    </div>
                    <div class="form-group">
                        <label for="amount">Amount</label><small class="text-danger">*</small>
                        <input type="text" name="amount" class="form-control" id="amount"  value="{{ $expensecat->amount}}">
                ...
                <div class="col-md-6 ">
                        ...
                        <div class="form-group">
                          ...
                          <textarea class="form-control" id="description" name="description">{{ $expensecat->description}}</textarea>
                        </div>
                      </div>
                    </div>
                    </div>
