       ...
       <body>    
        <style type="text/css">
          ...
          <!-- <div class="card-header"> -->
            <h3 class="panel-title"><center><strong>Class  Payments  Details</strong></center></h3>
          <!-- </div> -->
          <br>
          <div>
   <form enctype="multipart/form-data" class="form-inline" method="post" action="{{ url('admin/view-studentpayment-report') }}" name="add_Place" id="add_Place" >  {{ csrf_field() }}
                  ...
                  <input type="button" onclick="location.href='{{ url('admin/view-studentpayment-report') }}';" id="tempadd" value="Reset " class="btn btn-danger btn-sm">
                   </form>
                   </div>
             ...
             <table border="1">
                  <thead>
                   ...
                   <th style="width:150px;" class="text-center"> Subject </th>
                  ...
                  <tbody>
                    ...
                    @foreach($levels as $pro)
                                <tr>
                                  <td>{{ $i}}</td>
                                <td class="text-center">{{ $pro->subject }}</td>
                            
                               <td style="text-align: center;">{{ $pro->total }}</td>
