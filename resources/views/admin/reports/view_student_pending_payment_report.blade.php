       ...
       <body>    
        <style type="text/css">
          ...
          <!-- <div class="card-header"> -->
            <h3 class="panel-title"><center><strong>Student  Pending Payment Details</strong></center></h3>
          <!-- </div> -->
          <br>
          <div>
   <form enctype="multipart/form-data" class="form-inline" method="post" action="{{ url('admin/view-student-pending-payment-report') }}" name="add_Place" id="add_Place" >  {{ csrf_field() }}
                  ...
                  <input type="button" onclick="location.href='{{ url('admin/view-student-pending-payment-report') }}';" id="tempadd" value="Reset " class="btn btn-danger btn-sm">
                   </form>
                   </div>
             ...
             <table border="1">
                  ...
                  <tbody>
                    ...
                    @foreach($levels as $pro)
                                <tr>
                                  <td>{{ $i}}</td>
                                <td class="text-left">{{ $pro->student_id }}</td>
